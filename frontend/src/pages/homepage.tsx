...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#e9ddd0] 2xl:flex 2xl:justify-center">
      <div className="relative flex overflow-hidden flex-col min-h-screen bg-gradient-to-b from-[#1a0002] to-[#0d1418] w-full 2xl:max-w-[60%] 2xl:shadow-2xl transition-all duration-300">
        <Header />
        ...
        <main className="flex-grow">
          ...
          <motion.section
            ...
            className="mt-6 lg:mt-8 w-full h-[55vh] sm:h-[60vh] md:h-[70vh] lg:h-screen relative"
          ...
          <section className="sm:py-16 px-4 md:px-8 lg:px-16">
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col sm:flex-row gap-10 justify-center items-center">
                ...
                >
                  <h2 className="text-3xl md:text-6xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#F96666] to-[#ff9e9e] leading-tight drop-shadow-lg">
                    Awaken Your Soul to{" "}
                    <span className="text-white block mt-2">New Horizons</span>
                  </h2>
                  <p className="text-gray-200 text-base md:text-lg leading-relaxed font-light tracking-wide">
                    Embark on a journey of self-discovery. Capture the essence
                    of the unseen, whisper your tales to the winds, and let your
                    spirit dance with the rhythms of the world. Connect with
                    souls that resonate with your adventure.
                  </p>
                  <div className="relative pl-6 border-l-4 border-[#F96666]">
                    <blockquote className="text-lg lg:text-2xl italic text-white/90 font-serif">
                      "True explorers don't just witness the world,
                      <br />
                      they let it{" "}
                      <span className="text-[#F96666]">
                        rewrite their souls
                      </span>
                      ."
                    </blockquote>
                    <div className="absolute -top-4 -left-3 text-6xl text-[#F96666] opacity-30 font-serif">
                      "
                    </div>
                  </div>
                </motion.div>
          ...
          <section className="py-20 px-4 md:px-8 lg:px-16 bg-black/30">
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-300 text-lg max-w-3xl mx-auto">
                  More than just a blog platform — we're a community of
                  passionate travelers helping each other discover the world.
                </p>
              </motion.div>
