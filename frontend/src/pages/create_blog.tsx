  ...
  return (
    <div className="p-4 max-w-3xl mx-auto text-xs">
      <div className="py-2 max-w-3xl">
        <div className="mx-auto w-full h-10 text-sm lg:text-lg border-2  border-red-500 rounded-lg overflow-hidden bg-red-500 text-white tracking-wide group transition-all duration-500 relative flex items-center justify-center">
      ...
      {loading && (
        <div className="flex justify-center items-center my-4">
          ...
          <span className="ml-4 text-red-500 text-xs font-semibold">
            Creating Blog...
          </span>
        </div>
      )}
      ...
      <form
        ...
        className="flex flex-col gap-3 bg-white p-6 rounded-lg shadow-xl"
      >
        <div
